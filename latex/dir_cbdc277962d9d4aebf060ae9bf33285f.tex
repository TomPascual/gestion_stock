...
\href{https://packagist.org/packages/myclabs/deep-copy}{\texttt{ }} \href{https://github.com/myclabs/DeepCopy/actions/workflows/ci.yaml}{\texttt{ }}\hypertarget{README.md_autotoc_md1267}{}\doxysubsection{\texorpdfstring{Table of Contents}{Table of Contents}}\label{README.md_autotoc_md1267}
...
\end{DoxyEnumerate}
\end{DoxyEnumerate}\hypertarget{README.md_autotoc_md1268}{}\doxysubsection{\texorpdfstring{How?}{How?}}\label{README.md_autotoc_md1268}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1269}{}\doxysubsection{\texorpdfstring{Why?}{Why?}}\label{README.md_autotoc_md1269}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\$myCopy\ =\ \mbox{\hyperlink{namespace_carbon_1_1_traits_ab9cb43f7b45f227d2426299bac08b6ef}{clone}}\ \$myObject;}
...
\hypertarget{README.md_autotoc_md1270}{}\doxysubsubsection{\texorpdfstring{Using simply {\ttfamily clone}}{Using simply {\ttfamily clone}}}\label{README.md_autotoc_md1270}
\hypertarget{README.md_autotoc_md1271}{}\doxysubsubsection{\texorpdfstring{Overriding {\ttfamily \+\_\+\+\_\+clone()}}{Overriding {\ttfamily \+\_\+\+\_\+clone()}}}\label{README.md_autotoc_md1271}
\hypertarget{README.md_autotoc_md1272}{}\doxysubsubsection{\texorpdfstring{With {\ttfamily Deep\+Copy}}{With {\ttfamily Deep\+Copy}}}\label{README.md_autotoc_md1272}
\hypertarget{README.md_autotoc_md1273}{}\doxysubsection{\texorpdfstring{How it works}{How it works}}\label{README.md_autotoc_md1273}
...
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{\ \ \ \ }
\DoxyCodeLine{\ \ \ \ \textcolor{keywordflow}{return}\ \$copier-\/>\mbox{\hyperlink{class_deep_copy_1_1_deep_copy_af7e11376bd6b72fd6298e60afbe765f9}{copy}}(\$var);}
\DoxyCodeLine{\}}

\end{DoxyCode}
\hypertarget{README.md_autotoc_md1274}{}\doxysubsection{\texorpdfstring{Going further}{Going further}}\label{README.md_autotoc_md1274}
...
We provide some generic filters and matchers.\hypertarget{README.md_autotoc_md1275}{}\doxysubsubsection{\texorpdfstring{Matchers}{Matchers}}\label{README.md_autotoc_md1275}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1276}{}\doxysubsubsubsection{\texorpdfstring{Property name}{Property name}}\label{README.md_autotoc_md1276}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1277}{}\doxysubsubsubsection{\texorpdfstring{Specific property}{Specific property}}\label{README.md_autotoc_md1277}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1278}{}\doxysubsubsubsection{\texorpdfstring{Type}{Type}}\label{README.md_autotoc_md1278}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1279}{}\doxysubsubsection{\texorpdfstring{Filters}{Filters}}\label{README.md_autotoc_md1279}
...
By design, matching a filter will stop the chain of filters (i.\+e. the next ones will not be applied). Using the (\`{}\+Chainable\+Filter\`{}) won\textquotesingle{}t stop the chain of filters.\hypertarget{README.md_autotoc_md1280}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily Set\+Null\+Filter} (filter)}{{\ttfamily Set\+Null\+Filter} (filter)}}\label{README.md_autotoc_md1280}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1281}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily Keep\+Filter} (filter)}{{\ttfamily Keep\+Filter} (filter)}}\label{README.md_autotoc_md1281}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1282}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily Chainable\+Filter} (filter)}{{\ttfamily Chainable\+Filter} (filter)}}\label{README.md_autotoc_md1282}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1283}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily Doctrine\+Collection\+Filter} (filter)}{{\ttfamily Doctrine\+Collection\+Filter} (filter)}}\label{README.md_autotoc_md1283}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1284}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily Doctrine\+Empty\+Collection\+Filter} (filter)}{{\ttfamily Doctrine\+Empty\+Collection\+Filter} (filter)}}\label{README.md_autotoc_md1284}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1285}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily Doctrine\+Proxy\+Filter} (filter)}{{\ttfamily Doctrine\+Proxy\+Filter} (filter)}}\label{README.md_autotoc_md1285}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1286}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily Replace\+Filter} (type filter)}{{\ttfamily Replace\+Filter} (type filter)}}\label{README.md_autotoc_md1286}
...
The {\ttfamily \$callback} parameter of the {\ttfamily Replace\+Filter} constructor accepts any PHP callable.\hypertarget{README.md_autotoc_md1287}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily Shallow\+Copy\+Filter} (type filter)}{{\ttfamily Shallow\+Copy\+Filter} (type filter)}}\label{README.md_autotoc_md1287}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1288}{}\doxysubsection{\texorpdfstring{Edge cases}{Edge cases}}\label{README.md_autotoc_md1288}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1289}{}\doxysubsection{\texorpdfstring{Contributing}{Contributing}}\label{README.md_autotoc_md1289}
Deep\+Copy is distributed under the MIT license.\hypertarget{README.md_autotoc_md1290}{}\doxysubsubsection{\texorpdfstring{Tests}{Tests}}\label{README.md_autotoc_md1290}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1291}{}\doxysubsubsection{\texorpdfstring{Support}{Support}}\label{README.md_autotoc_md1291}
