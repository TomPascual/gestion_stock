...
\href{https://travis-ci.org/phar-io/version}{\texttt{ }}\hypertarget{README.md_autotoc_md1379}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{README.md_autotoc_md1379}
...
\end{DoxyVerb}
\hypertarget{README.md_autotoc_md1380}{}\doxysubsection{\texorpdfstring{Version constraints}{Version constraints}}\label{README.md_autotoc_md1380}
...
{\itshape Tilde operator}\+: {\ttfamily \texorpdfstring{$\sim$}{\string~}1.0.\+0} can be written as {\ttfamily \texorpdfstring{$>$}{>}=1.\+0.\+0 \texorpdfstring{$<$}{<}1.\+1.\+0} and read as »every version within minor version {\ttfamily 1.\+1}. The behavior of tilde operator depends on whether a patch level version is provided or not. If no patch level is provided, tilde operator behaves like the caret operator\+: {\ttfamily \texorpdfstring{$\sim$}{\string~}1.0} is identical to {\ttfamily \texorpdfstring{$^\wedge$}{\string^}1.0}.\hypertarget{README.md_autotoc_md1381}{}\doxysubsection{\texorpdfstring{Usage examples}{Usage examples}}\label{README.md_autotoc_md1381}
