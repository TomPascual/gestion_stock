...
\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md447}{}\doxysection{\texorpdfstring{6.\+0 to 7.\+0}{6.\+0 to 7.\+0}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md447}
...
\end{DoxyItemize}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md448}{}\doxysubsubsection{\texorpdfstring{Other backwards compatibility breaking changes}{Other backwards compatibility breaking changes}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md448}

\begin{DoxyItemize}
\item Class {\ttfamily Guzzle\+Http\textbackslash{}Uri\+Template} is removed.
\item Class {\ttfamily Guzzle\+Http\textbackslash{}Exception\textbackslash{}Seek\+Exception} is removed.
\item Classes {\ttfamily Guzzle\+Http\textbackslash{}Exception\textbackslash{}Bad\+Response\+Exception}, {\ttfamily Guzzle\+Http\textbackslash{}Exception\textbackslash{}Client\+Exception}, {\ttfamily Guzzle\+Http\textbackslash{}Exception\textbackslash{}Server\+Exception} can no longer be initialized with an empty Response as argument.
\item Class {\ttfamily Guzzle\+Http\textbackslash{}Exception\textbackslash{}Connect\+Exception} now extends {\ttfamily Guzzle\+Http\textbackslash{}Exception\textbackslash{}Transfer\+Exception} instead of {\ttfamily Guzzle\+Http\textbackslash{}Exception\textbackslash{}Request\+Exception}.
\item Function {\ttfamily Guzzle\+Http\textbackslash{}Exception\textbackslash{}Connect\+Exception\+::get\+Response()} is removed.
\item Function {\ttfamily Guzzle\+Http\textbackslash{}Exception\textbackslash{}Connect\+Exception\+::has\+Response()} is removed.
\item Constant {\ttfamily Guzzle\+Http\textbackslash{}Client\+Interface\+::\+VERSION} is removed. Added {\ttfamily Guzzle\+Http\textbackslash{}Client\+Interface\+::\+MAJOR\+\_\+\+VERSION} instead.
\item Function {\ttfamily Guzzle\+Http\textbackslash{}Exception\textbackslash{}Request\+Exception\+::get\+Response\+Body\+Summary} is removed. Use {\ttfamily \textbackslash{}Guzzle\+Http\textbackslash{}Psr7\textbackslash{}get\+\_\+message\+\_\+body\+\_\+summary} as an alternative.
\item Function {\ttfamily Guzzle\+Http\textbackslash{}Cookie\textbackslash{}Cookie\+Jar\+::get\+Cookie\+Value} is removed.
...
\end{DoxyItemize}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md449}{}\doxysubsubsection{\texorpdfstring{Native functions calls}{Native functions calls}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md449}
...
For the full diff you can check \href{https://github.com/guzzle/guzzle/compare/6.5.4..master}{\texttt{ here}}.\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md450}{}\doxysection{\texorpdfstring{5.\+0 to 6.\+0}{5.\+0 to 6.\+0}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md450}
Guzzle now uses \href{https://www.php-fig.org/psr/psr-7/}{\texttt{ PSR-\/7}} for HTTP messages. Due to the fact that these messages are immutable, this prompted a refactoring of Guzzle to use a middleware based system rather than an event system. Any HTTP message interaction (e.\+g., {\ttfamily Guzzle\+Http\textbackslash{}Message\textbackslash{}Request}) need to be updated to work with the new immutable PSR-\/7 request and response objects. Any event listeners or subscribers need to be updated to become middleware functions that wrap handlers (or are injected into a {\ttfamily Guzzle\+Http\textbackslash{}Handler\+Stack}).


\begin{DoxyItemize}
\item Removed {\ttfamily Guzzle\+Http\textbackslash{}Batch\+Results}
\item Removed {\ttfamily Guzzle\+Http\textbackslash{}Collection}
\item Removed {\ttfamily Guzzle\+Http\textbackslash{}Has\+Data\+Trait}
\item Removed {\ttfamily Guzzle\+Http\textbackslash{}To\+Array\+Interface}
\item The {\ttfamily guzzlehttp/streams} dependency has been removed. Stream functionality is now present in the {\ttfamily Guzzle\+Http\textbackslash{}Psr7} namespace provided by the {\ttfamily guzzlehttp/psr7} package.
...
\end{DoxyEnumerate}
\item {\ttfamily Guzzle\+Http\textbackslash{}Mimetypes} has been moved to a function in {\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}mimetype\+\_\+from\+\_\+extension} and {\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}mimetype\+\_\+from\+\_\+filename}.
\item {\ttfamily Guzzle\+Http\textbackslash{}Query} and {\ttfamily Guzzle\+Http\textbackslash{}Query\+Parser} have been removed. Query strings must now be passed into request objects as strings, or provided to the {\ttfamily query} request option when creating requests with clients. The {\ttfamily query} option uses PHP\textquotesingle{}s {\ttfamily http\+\_\+build\+\_\+query} to convert an array to a string. If you need a different serialization technique, you will need to pass the query string in as a string. There are a couple helper functions that will make working with query strings easier\+: {\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}parse\+\_\+query} and {\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}build\+\_\+query}.
\item Guzzle no longer has a dependency on Ring\+PHP. Due to the use of a middleware system based on PSR-\/7, using Ring\+PHP and it\textquotesingle{}s middleware system as well adds more complexity than the benefits it provides. All HTTP handlers that were present in Ring\+PHP have been modified to work directly with PSR-\/7 messages and placed in the {\ttfamily Guzzle\+Http\textbackslash{}Handler} namespace. This significantly reduces complexity in Guzzle, removes a dependency, and improves performance. Ring\+PHP will be maintained for Guzzle 5 support, but will no longer be a part of Guzzle 6.
...
\item {\ttfamily Guzzle\+Http\textbackslash{}Subscriber\textbackslash{}Cookie} is now provided by {\ttfamily Guzzle\+Http\textbackslash{}Middleware\+::cookies}
\item {\ttfamily Guzzle\+Http\textbackslash{}Subscriber\textbackslash{}Http\+Error} is now provided by {\ttfamily Guzzle\+Http\textbackslash{}Middleware\+::http\+Error}
\item {\ttfamily Guzzle\+Http\textbackslash{}Subscriber\textbackslash{}History} is now provided by {\ttfamily Guzzle\+Http\textbackslash{}Middleware\+::history}
\item {\ttfamily Guzzle\+Http\textbackslash{}Subscriber\textbackslash{}Mock} is now provided by {\ttfamily Guzzle\+Http\textbackslash{}Handler\textbackslash{}Mock\+Handler}
\item {\ttfamily Guzzle\+Http\textbackslash{}Subscriber\textbackslash{}Prepare} is now provided by {\ttfamily Guzzle\+Http\textbackslash{}Prepare\+Body\+Middleware}
\item {\ttfamily Guzzle\+Http\textbackslash{}Subscriber\textbackslash{}Redirect} is now provided by {\ttfamily Guzzle\+Http\textbackslash{}Redirect\+Middleware}
\end{DoxyItemize}
\item Guzzle now uses {\ttfamily Psr\textbackslash{}Http\textbackslash{}Message\textbackslash{}Uri\+Interface} (implements in {\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri}) for URI support. {\ttfamily Guzzle\+Http\textbackslash{}Url} is now gone.
\item Static functions in {\ttfamily Guzzle\+Http\textbackslash{}Utils} have been moved to namespaced functions under the {\ttfamily Guzzle\+Http} namespace. This requires either a Composer based autoloader or you to include functions.\+php.
\item {\ttfamily Guzzle\+Http\textbackslash{}Client\+Interface\+::get\+Default\+Option} has been renamed to {\ttfamily Guzzle\+Http\textbackslash{}Client\+Interface\+::get\+Config}.
\item {\ttfamily Guzzle\+Http\textbackslash{}Client\+Interface\+::set\+Default\+Option} has been removed.
...
\end{DoxyItemize}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md451}{}\doxysection{\texorpdfstring{Migrating to middleware}{Migrating to middleware}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md451}
...
\DoxyCodeLine{\$handler\ =\ \mbox{\hyperlink{class_guzzle_http_1_1_handler_stack_afa50b4f0a8b132264934bf9ad17f5d34}{GuzzleHttp\(\backslash\)HandlerStack::create}}();}
...
\end{DoxyCode}
\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md452}{}\doxysection{\texorpdfstring{POST Requests}{POST Requests}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md452}
...
{\ttfamily Guzzle\+Http\textbackslash{}Post\textbackslash{}Post\+File} has been removed. Use the {\ttfamily multipart} option to add POST files to a multipart/form-\/data request.
...
The {\ttfamily base\+\_\+url} option has been renamed to {\ttfamily base\+\_\+uri}.\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md453}{}\doxysection{\texorpdfstring{4.\+x to 5.\+0}{4.\+x to 5.\+0}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md453}
\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md454}{}\doxysection{\texorpdfstring{Rewritten Adapter Layer}{Rewritten Adapter Layer}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md454}
Guzzle now uses \href{https://ringphp.readthedocs.org/en/latest}{\texttt{ Ring\+PHP}} to send HTTP requests. The {\ttfamily adapter} option in a {\ttfamily Guzzle\+Http\textbackslash{}Client} constructor is still supported, but it has now been renamed to {\ttfamily handler}. Instead of passing a {\ttfamily Guzzle\+Http\textbackslash{}Adapter\textbackslash{}Adapter\+Interface}, you must now pass a PHP {\ttfamily callable} that follows the Ring\+PHP specification.\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md455}{}\doxysection{\texorpdfstring{Removed Fluent Interfaces}{Removed Fluent Interfaces}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md455}
...
\begin{DoxyItemize}
\item {\ttfamily Guzzle\+Http\textbackslash{}Collection}
\item {\ttfamily Guzzle\+Http\textbackslash{}Url}
\item {\ttfamily Guzzle\+Http\textbackslash{}Query}
\item {\ttfamily Guzzle\+Http\textbackslash{}Post\textbackslash{}Post\+Body}
\item {\ttfamily Guzzle\+Http\textbackslash{}Cookie\textbackslash{}Set\+Cookie}
\end{DoxyItemize}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md456}{}\doxysection{\texorpdfstring{Removed functions.\+php}{Removed functions.\+php}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md456}
Removed "{}functions.\+php"{}, so that Guzzle is truly PSR-\/4 compliant. The following functions can be used as replacements.


\begin{DoxyItemize}
\item {\ttfamily Guzzle\+Http\textbackslash{}json\+\_\+decode} -\/\texorpdfstring{$>$}{>} {\ttfamily Guzzle\+Http\textbackslash{}Utils\+::json\+Decode}
\item {\ttfamily Guzzle\+Http\textbackslash{}get\+\_\+path} -\/\texorpdfstring{$>$}{>} {\ttfamily Guzzle\+Http\textbackslash{}Utils\+::get\+Path}
\item {\ttfamily Guzzle\+Http\textbackslash{}Utils\+::set\+Path} -\/\texorpdfstring{$>$}{>} {\ttfamily Guzzle\+Http\textbackslash{}set\+\_\+path}
\item {\ttfamily Guzzle\+Http\textbackslash{}Pool\+::batch} -\/\texorpdfstring{$>$}{>} {\ttfamily Guzzle\+Http\textbackslash{}batch}. This function is, however, deprecated in favor of using {\ttfamily Guzzle\+Http\textbackslash{}Pool\+::batch()}.
\end{DoxyItemize}

The "{}procedural"{} global client has been removed with no replacement (e.\+g., {\ttfamily Guzzle\+Http\textbackslash{}get()}, {\ttfamily Guzzle\+Http\textbackslash{}post()}, etc.). Use a {\ttfamily Guzzle\+Http\textbackslash{}Client} object as a replacement.\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md457}{}\doxysection{\texorpdfstring{{\ttfamily throw\+Immediately} has been removed}{{\ttfamily throw\+Immediately} has been removed}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md457}
The concept of "{}throw\+Immediately"{} has been removed from exceptions and error events. This control mechanism was used to stop a transfer of concurrent requests from completing. This can now be handled by throwing the exception or by cancelling a pool of requests or each outstanding future request individually.\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md458}{}\doxysection{\texorpdfstring{headers event has been removed}{headers event has been removed}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md458}
Removed the "{}headers"{} event. This event was only useful for changing the body a response once the headers of the response were known. You can implement a similar behavior in a number of ways. One example might be to use a Fn\+Stream that has access to the transaction being sent. For example, when the first byte is written, you could check if the response headers match your expectations, and if so, change the actual stream body that is being written to.\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md459}{}\doxysection{\texorpdfstring{Updates to HTTP Messages}{Updates to HTTP Messages}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md459}
Removed the {\ttfamily as\+Array} parameter from {\ttfamily Guzzle\+Http\textbackslash{}Message\textbackslash{}Message\+Interface\+::get\+Header}. If you want to get a header value as an array, then use the newly added {\ttfamily get\+Header\+As\+Array()} method of {\ttfamily Message\+Interface}. This change makes the Guzzle interfaces compatible with the PSR-\/7 interfaces.\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md460}{}\doxysection{\texorpdfstring{3.\+x to 4.\+0}{3.\+x to 4.\+0}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md460}
\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md461}{}\doxysection{\texorpdfstring{Overarching changes\+:}{Overarching changes\+:}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md461}
...
\item No longer requiring the Symfony Event\+Dispatcher. A custom event dispatcher based on the Symfony Event\+Dispatcher is now utilized in {\ttfamily Guzzle\+Http\textbackslash{}Event\textbackslash{}Emitter\+Interface} (resulting in significant speed and functionality improvements).
\end{DoxyItemize}

Changes per Guzzle 3.\+x namespace are described below.\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md462}{}\doxysection{\texorpdfstring{Batch}{Batch}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md462}
The {\ttfamily Guzzle\textbackslash{}Batch} namespace has been removed. This is best left to third-\/parties to implement on top of Guzzle\textquotesingle{}s core HTTP library.\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md463}{}\doxysection{\texorpdfstring{Cache}{Cache}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md463}
The {\ttfamily Guzzle\textbackslash{}Cache} namespace has been removed. (Todo\+: No suitable replacement has been implemented yet, but hoping to utilize a PSR cache interface).\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md464}{}\doxysection{\texorpdfstring{Common}{Common}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md464}
...
\item {\ttfamily Guzzle\textbackslash{}Common\textbackslash{}Version} has been removed. The VERSION constant can be found at {\ttfamily Guzzle\+Http\textbackslash{}Client\+Interface\+::\+VERSION}.
\end{DoxyItemize}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md465}{}\doxysubsection{\texorpdfstring{Collection}{Collection}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md465}
...
\end{DoxyItemize}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md466}{}\doxysubsection{\texorpdfstring{Events}{Events}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md466}
Guzzle no longer requires Symfony\textquotesingle{}s Event\+Dispatcher component. Guzzle now uses {\ttfamily Guzzle\+Http\textbackslash{}Event\textbackslash{}Emitter}.


\begin{DoxyItemize}
\item {\ttfamily Symfony\textbackslash{}Component\textbackslash{}Event\+Dispatcher\textbackslash{}Event\+Dispatcher\+Interface} is replaced by {\ttfamily Guzzle\+Http\textbackslash{}Event\textbackslash{}Emitter\+Interface}.
\item {\ttfamily Symfony\textbackslash{}Component\textbackslash{}Event\+Dispatcher\textbackslash{}Event\+Dispatcher} is replaced by {\ttfamily Guzzle\+Http\textbackslash{}Event\textbackslash{}Emitter}.
\item {\ttfamily Symfony\textbackslash{}Component\textbackslash{}Event\+Dispatcher\textbackslash{}Event} is replaced by {\ttfamily Guzzle\+Http\textbackslash{}Event\textbackslash{}Event}, and Guzzle now has an Event\+Interface in {\ttfamily Guzzle\+Http\textbackslash{}Event\textbackslash{}Event\+Interface}.
...
\end{DoxyItemize}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md467}{}\doxysubsubsection{\texorpdfstring{Emitter}{Emitter}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md467}
...
\end{DoxyCode}
\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md468}{}\doxysection{\texorpdfstring{Http}{Http}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md468}
\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md469}{}\doxysubsection{\texorpdfstring{General changes}{General changes}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md469}
...
\item {\ttfamily Guzzle\textbackslash{}Http\textbackslash{}Url} has moved to {\ttfamily Guzzle\+Http\textbackslash{}Url}.
\item {\ttfamily Guzzle\textbackslash{}Http\textbackslash{}Query\+String} has moved to {\ttfamily Guzzle\+Http\textbackslash{}Query}.
\item Query\+Aggregators have been rewritten so that they are simply callable functions.
\item {\ttfamily Guzzle\+Http\textbackslash{}Static\+Client} has been removed. Use the functions provided in {\ttfamily functions.\+php} for an easy to use static client instance.
\item Exceptions in {\ttfamily Guzzle\+Http\textbackslash{}Exception} have been updated to all extend from {\ttfamily Guzzle\+Http\textbackslash{}Exception\textbackslash{}Transfer\+Exception}.
\end{DoxyItemize}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md470}{}\doxysubsection{\texorpdfstring{Client}{Client}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md470}
...
{\ttfamily Guzzle\+Http\textbackslash{}Client\+Interface} has changed.
...
{\ttfamily Guzzle\+Http\textbackslash{}Client} has changed.
...
\end{DoxyItemize}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md471}{}\doxysubsection{\texorpdfstring{Messages}{Messages}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md471}
Messages no longer have references to their counterparts (i.\+e., a request no longer has a reference to it\textquotesingle{}s response, and a response no loger has a reference to its request). This association is now managed through a {\ttfamily Guzzle\+Http\textbackslash{}Adapter\textbackslash{}Transaction\+Interface} object. You can get references to these transaction objects using request events that are emitted over the lifecycle of a request.\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md472}{}\doxysubsubsection{\texorpdfstring{Requests with a body}{Requests with a body}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md472}

\begin{DoxyItemize}
\item {\ttfamily Guzzle\+Http\textbackslash{}Message\textbackslash{}Entity\+Enclosing\+Request} and {\ttfamily Guzzle\+Http\textbackslash{}Message\textbackslash{}Entity\+Enclosing\+Request\+Interface} have been removed. The separation between requests that contain a body and requests that do not contain a body has been removed, and now {\ttfamily Guzzle\+Http\textbackslash{}Message\textbackslash{}Request\+Interface} handles both use cases.
\item Any method that previously accepts a {\ttfamily Guzzle\+Http\textbackslash{}Response} object now accept a {\ttfamily Guzzle\+Http\textbackslash{}Message\textbackslash{}Response\+Interface}.
\item {\ttfamily Guzzle\+Http\textbackslash{}Message\textbackslash{}Request\+Factory\+Interface} has been renamed to {\ttfamily Guzzle\+Http\textbackslash{}Message\textbackslash{}Message\+Factory\+Interface}. This interface is used to create both requests and responses and is implemented in {\ttfamily Guzzle\+Http\textbackslash{}Message\textbackslash{}Message\+Factory}.
\item POST field and file methods have been removed from the request object. You must now use the methods made available to {\ttfamily Guzzle\+Http\textbackslash{}Post\textbackslash{}Post\+Body\+Interface} to control the format of a POST body. Requests that are created using a standard {\ttfamily Guzzle\+Http\textbackslash{}Message\textbackslash{}Message\+Factory\+Interface} will automatically use a {\ttfamily Guzzle\+Http\textbackslash{}Post\textbackslash{}Post\+Body} body if the body was passed as an array or if the method is POST and no body is provided.
\end{DoxyItemize}
...
\end{DoxyCode}
\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md473}{}\doxysubsubsection{\texorpdfstring{Headers}{Headers}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md473}

\begin{DoxyItemize}
\item {\ttfamily Guzzle\+Http\textbackslash{}Message\textbackslash{}Header} has been removed. Header values are now simply represented by an array of values or as a string. Header values are returned as a string by default when retrieving a header value from a message. You can pass an optional argument of {\ttfamily true} to retrieve a header value as an array of strings instead of a single concatenated string.
\item {\ttfamily Guzzle\+Http\textbackslash{}Post\+File} and {\ttfamily Guzzle\+Http\textbackslash{}Post\+File\+Interface} have been moved to {\ttfamily Guzzle\+Http\textbackslash{}Post}. This interface has been simplified and now allows the addition of arbitrary headers.
\item Custom headers like {\ttfamily Guzzle\+Http\textbackslash{}Message\textbackslash{}Header\textbackslash{}Link} have been removed. Most of the custom headers are now handled separately in specific subscribers/plugins, and {\ttfamily Guzzle\+Http\textbackslash{}Message\textbackslash{}Header\+Values\+::parse\+Params()} has been updated to properly handle headers that contain parameters (like the {\ttfamily Link} header).
\end{DoxyItemize}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md474}{}\doxysubsubsection{\texorpdfstring{Responses}{Responses}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md474}

\begin{DoxyItemize}
\item {\ttfamily Guzzle\+Http\textbackslash{}Message\textbackslash{}Response\+::get\+Info()} and {\ttfamily Guzzle\+Http\textbackslash{}Message\textbackslash{}Response\+::set\+Info()} have been removed. Use the event system to retrieve this type of information.
\item {\ttfamily Guzzle\+Http\textbackslash{}Message\textbackslash{}Response\+::get\+Raw\+Headers()} has been removed.
\item {\ttfamily Guzzle\+Http\textbackslash{}Message\textbackslash{}Response\+::get\+Message()} has been removed.
\item {\ttfamily Guzzle\+Http\textbackslash{}Message\textbackslash{}Response\+::calculate\+Age()} and other cache specific methods have moved to the Cache\+Subscriber.
\item Header specific helper functions like {\ttfamily get\+Content\+Md5()} have been removed. Just use `get\+Header(\textquotesingle{}Content-\/\+MD5'){\ttfamily instead. -\/}Guzzle\+Http\textbackslash{}\+Message\textbackslash{}\+Response\+::set\+Request(){\ttfamily and }Guzzle\+Http\textbackslash{}\+Message\textbackslash{}\+Response\+::get\+Request(){\ttfamily have been removed. Use the event system to work with request and response objects as a transaction. -\/}Guzzle\+Http\textbackslash{}\+Message\textbackslash{}\+Response\+::get\+Redirect\+Count(){\ttfamily has been removed. Use the Redirect subscriber instead. -\/}Guzzle\+Http\textbackslash{}\+Message\textbackslash{}\+Response\+::is\+Successful(){\ttfamily and other related methods have been removed. Use}get\+Status\+Code()\`{} instead.
\end{DoxyItemize}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md475}{}\doxysubsubsection{\texorpdfstring{Streaming responses}{Streaming responses}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md475}
Streaming requests can now be created by a client directly, returning a {\ttfamily Guzzle\+Http\textbackslash{}Message\textbackslash{}Response\+Interface} object that contains a body stream referencing an open PHP HTTP stream.
...
\end{DoxyCode}
\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md476}{}\doxysubsubsection{\texorpdfstring{Redirects}{Redirects}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md476}
...
\end{DoxyCode}
\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md477}{}\doxysubsubsection{\texorpdfstring{Entity\+Body}{Entity\+Body}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md477}
Entity\+Body interfaces and classes have been removed or moved to {\ttfamily Guzzle\+Http\textbackslash{}Stream}. All classes and interfaces that once required {\ttfamily Guzzle\+Http\textbackslash{}Entity\+Body\+Interface} now require {\ttfamily Guzzle\+Http\textbackslash{}Stream\textbackslash{}Stream\+Interface}. Creating a new body for a request no longer uses {\ttfamily Guzzle\+Http\textbackslash{}Entity\+Body\+::factory} but now uses {\ttfamily Guzzle\+Http\textbackslash{}Stream\textbackslash{}Stream\+::factory} or even better\+: {\ttfamily Guzzle\+Http\textbackslash{}Stream\textbackslash{}create()}.


\begin{DoxyItemize}
\item {\ttfamily Guzzle\textbackslash{}Http\textbackslash{}Entity\+Body\+Interface} is now {\ttfamily Guzzle\+Http\textbackslash{}Stream\textbackslash{}Stream\+Interface}
\item {\ttfamily Guzzle\textbackslash{}Http\textbackslash{}Entity\+Body} is now {\ttfamily Guzzle\+Http\textbackslash{}Stream\textbackslash{}Stream}
\item {\ttfamily Guzzle\textbackslash{}Http\textbackslash{}Caching\+Entity\+Body} is now {\ttfamily Guzzle\+Http\textbackslash{}Stream\textbackslash{}Caching\+Stream}
\item {\ttfamily Guzzle\textbackslash{}Http\textbackslash{}Read\+Limit\+Entity\+Body} is now {\ttfamily Guzzle\+Http\textbackslash{}Stream\textbackslash{}Limit\+Stream}
\item {\ttfamily Guzzle\textbackslash{}Http\textbackslash{}Io\+Emittyin\+Entity\+Body} has been removed.
\end{DoxyItemize}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md478}{}\doxysubsubsection{\texorpdfstring{Request lifecycle events}{Request lifecycle events}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md478}
Requests previously submitted a large number of requests. The number of events emitted over the lifecycle of a request has been significantly reduced to make it easier to understand how to extend the behavior of a request. All events emitted during the lifecycle of a request now emit a custom {\ttfamily Guzzle\+Http\textbackslash{}Event\textbackslash{}Event\+Interface} object that contains context providing methods and a way in which to modify the transaction at that specific point in time (e.\+g., intercept the request and set a response on the transaction).


\begin{DoxyItemize}
\item {\ttfamily request.\+before\+\_\+send} has been renamed to {\ttfamily before} and now emits a {\ttfamily Guzzle\+Http\textbackslash{}Event\textbackslash{}Before\+Event}
\item {\ttfamily request.\+complete} has been renamed to {\ttfamily complete} and now emits a {\ttfamily Guzzle\+Http\textbackslash{}Event\textbackslash{}Complete\+Event}.
...
\item {\ttfamily error} is now an event that emits a {\ttfamily Guzzle\+Http\textbackslash{}Event\textbackslash{}Error\+Event}.
...
{\ttfamily headers} is a new event that is emitted after the response headers of a request have been received before the body of the response is downloaded. This event emits a {\ttfamily Guzzle\+Http\textbackslash{}Event\textbackslash{}Headers\+Event}.

You can intercept a request and inject a response using the {\ttfamily intercept()} event of a {\ttfamily Guzzle\+Http\textbackslash{}Event\textbackslash{}Before\+Event}, {\ttfamily Guzzle\+Http\textbackslash{}Event\textbackslash{}Complete\+Event}, and {\ttfamily Guzzle\+Http\textbackslash{}Event\textbackslash{}Error\+Event} event.

See\+: \href{https://docs.guzzlephp.org/en/latest/events.html}{\texttt{ https\+://docs.\+guzzlephp.\+org/en/latest/events.\+html}}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md479}{}\doxysection{\texorpdfstring{Inflection}{Inflection}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md479}
The {\ttfamily Guzzle\textbackslash{}Inflection} namespace has been removed. This is not a core concern of Guzzle.\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md480}{}\doxysection{\texorpdfstring{Iterator}{Iterator}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md480}
...
For a replacement of these iterators, see \href{https://github.com/nikic/iter}{\texttt{ https\+://github.\+com/nikic/iter}}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md481}{}\doxysection{\texorpdfstring{Log}{Log}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md481}
The Log\+Plugin has moved to \href{https://github.com/guzzle/log-subscriber}{\texttt{ https\+://github.\+com/guzzle/log-\/subscriber}}. The {\ttfamily Guzzle\textbackslash{}Log} namespace has been removed. Guzzle now relies on {\ttfamily Psr\textbackslash{}Log\textbackslash{}Logger\+Interface} for all logging. The Message\+Formatter class has been moved to {\ttfamily Guzzle\+Http\textbackslash{}Subscriber\textbackslash{}Log\textbackslash{}Formatter}.\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md482}{}\doxysection{\texorpdfstring{Parser}{Parser}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md482}
...
\begin{DoxyItemize}
\item Cookie\+: Cookie parsing logic has been moved to {\ttfamily Guzzle\+Http\textbackslash{}Cookie\textbackslash{}Set\+Cookie\+::from\+String}.
\item Message\+: Message parsing logic for both requests and responses has been moved to {\ttfamily Guzzle\+Http\textbackslash{}Message\textbackslash{}Message\+Factory\+::from\+Message}. Message parsing is only used in debugging or deserializing messages, so it doesn\textquotesingle{}t make sense for Guzzle as a library to add this level of complexity to parsing messages.
\item Uri\+Template\+: URI template parsing has been moved to {\ttfamily Guzzle\+Http\textbackslash{}Uri\+Template}. The Guzzle library will automatically use the PECL URI template library if it is installed.
\item Url\+: URL parsing is now performed in {\ttfamily Guzzle\+Http\textbackslash{}Url\+::from\+String} (previously it was {\ttfamily Guzzle\textbackslash{}Http\textbackslash{}Url\+::factory()}). If custom URL parsing is necessary, then developers are free to subclass {\ttfamily Guzzle\+Http\textbackslash{}Url}.
\end{DoxyItemize}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md483}{}\doxysection{\texorpdfstring{Plugin}{Plugin}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md483}
The {\ttfamily Guzzle\textbackslash{}Plugin} namespace has been renamed to {\ttfamily Guzzle\+Http\textbackslash{}Subscriber}. Several plugins are shipping with the core Guzzle library under this namespace.


\begin{DoxyItemize}
\item {\ttfamily Guzzle\+Http\textbackslash{}Subscriber\textbackslash{}Cookie}\+: Replaces the old Cookie\+Plugin. Cookie jar code has moved to {\ttfamily Guzzle\+Http\textbackslash{}Cookie}.
\item {\ttfamily Guzzle\+Http\textbackslash{}Subscriber\textbackslash{}History}\+: Replaces the old History\+Plugin.
\item {\ttfamily Guzzle\+Http\textbackslash{}Subscriber\textbackslash{}Http\+Error}\+: Throws errors when a bad HTTP response is received.
\item {\ttfamily Guzzle\+Http\textbackslash{}Subscriber\textbackslash{}Mock}\+: Replaces the old Mock\+Plugin.
\item {\ttfamily Guzzle\+Http\textbackslash{}Subscriber\textbackslash{}Prepare}\+: Prepares the body of a request just before sending. This subscriber is attached to all requests by default.
\item {\ttfamily Guzzle\+Http\textbackslash{}Subscriber\textbackslash{}Redirect}\+: Replaces the Redirect\+Plugin.
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item {\ttfamily Guzzle\+Http\textbackslash{}Plugin\textbackslash{}Async} has been removed.
\item {\ttfamily Guzzle\+Http\textbackslash{}Plugin\textbackslash{}Curl\+Auth} has been removed.
\item {\ttfamily Guzzle\+Http\textbackslash{}Plugin\textbackslash{}Error\+Response\textbackslash{}Error\+Response\+Plugin} has been removed. This functionality should instead be implemented with event listeners that occur after normal response parsing occurs in the guzzle/command package.
\end{DoxyItemize}
...
\item {\ttfamily Guzzle\textbackslash{}Http\textbackslash{}Plugin\textbackslash{}Mock\textbackslash{}Mock\+Plugin} has moved to {\ttfamily Guzzle\+Http\textbackslash{}Subscriber\textbackslash{}Mock\+Subscriber}.
...
\end{DoxyItemize}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md484}{}\doxysection{\texorpdfstring{Service}{Service}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md484}
...
\end{DoxyItemize}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md485}{}\doxysection{\texorpdfstring{Stream}{Stream}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md485}
...
{\ttfamily Guzzle\textbackslash{}Stream\textbackslash{}Stream\+Interface} has been given a large update to cleanly take on the responsibilities of {\ttfamily Guzzle\textbackslash{}Http\textbackslash{}Entity\+Body} and {\ttfamily Guzzle\textbackslash{}Http\textbackslash{}Entity\+Body\+Interface} now that they have been removed. The number of methods implemented by the {\ttfamily Stream\+Interface} has been drastically reduced to allow developers to more easily extend and decorate stream behavior.\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md486}{}\doxysection{\texorpdfstring{Removed methods from Stream\+Interface}{Removed methods from Stream\+Interface}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md486}

\begin{DoxyItemize}
\item {\ttfamily get\+Stream} and {\ttfamily set\+Stream} have been removed to better encapsulate streams.
\item {\ttfamily get\+Metadata} and {\ttfamily set\+Metadata} have been removed in favor of {\ttfamily Guzzle\+Http\textbackslash{}Stream\textbackslash{}Metadata\+Stream\+Interface}.
\item {\ttfamily get\+Wrapper}, {\ttfamily get\+Wrapper\+Data}, {\ttfamily get\+Stream\+Type}, and {\ttfamily get\+Uri} have all been removed. This data is accessible when using streams that implement {\ttfamily Guzzle\+Http\textbackslash{}Stream\textbackslash{}Metadata\+Stream\+Interface}.
\item {\ttfamily rewind} has been removed. Use {\ttfamily seek(0)} for a similar behavior.
\end{DoxyItemize}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md487}{}\doxysection{\texorpdfstring{Renamed methods}{Renamed methods}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md487}
...
\item {\ttfamily read\+Line} has moved from an instance method to a static class method of {\ttfamily Guzzle\+Http\textbackslash{}Stream\textbackslash{}Stream}.
\end{DoxyItemize}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md488}{}\doxysection{\texorpdfstring{Metadata streams}{Metadata streams}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md488}
{\ttfamily Guzzle\+Http\textbackslash{}Stream\textbackslash{}Metadata\+Stream\+Interface} has been added to denote streams that contain additional metadata accessible via {\ttfamily get\+Metadata()}. {\ttfamily Guzzle\+Http\textbackslash{}Stream\textbackslash{}Stream\+Interface\+::get\+Metadata} and {\ttfamily Guzzle\+Http\textbackslash{}Stream\textbackslash{}Stream\+Interface\+::set\+Metadata} have been removed.\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md489}{}\doxysection{\texorpdfstring{Stream\+Request\+Factory}{Stream\+Request\+Factory}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md489}
The entire concept of the Stream\+Request\+Factory has been removed. The way this was used in Guzzle 3 broke the actual interface of sending streaming requests (instead of getting back a Response, you got a Stream\+Interface). Streaming PHP requests are now implemented through the {\ttfamily Guzzle\+Http\textbackslash{}Adapter\textbackslash{}Stream\+Adapter}.\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md490}{}\doxysection{\texorpdfstring{3.\+6 to 3.\+7}{3.\+6 to 3.\+7}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md490}
\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md491}{}\doxysubsection{\texorpdfstring{Deprecations}{Deprecations}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md491}
...
\end{DoxyItemize}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md492}{}\doxysubsection{\texorpdfstring{Interface changes}{Interface changes}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md492}
...
\end{DoxyItemize}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md493}{}\doxysubsection{\texorpdfstring{Cache plugin breaking changes}{Cache plugin breaking changes}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md493}
...
\end{DoxyItemize}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md494}{}\doxysection{\texorpdfstring{3.\+5 to 3.\+6}{3.\+5 to 3.\+6}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md494}
...
If you previously relied on Guzzle\textbackslash{}\+Http\textbackslash{}\+Message\textbackslash{}\+Header\+::raw(), then you will need to update your code to use the Header\+Interface (e.\+g. to\+Array(), get\+All(), etc.).\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md495}{}\doxysubsection{\texorpdfstring{Interface changes}{Interface changes}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md495}
...
\end{DoxyItemize}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md496}{}\doxysubsection{\texorpdfstring{Removed deprecated functions}{Removed deprecated functions}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md496}
...
\end{DoxyItemize}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md497}{}\doxysubsection{\texorpdfstring{Deprecations}{Deprecations}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md497}
...
\end{DoxyItemize}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md498}{}\doxysubsection{\texorpdfstring{Other changes}{Other changes}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md498}
...
\end{DoxyItemize}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md499}{}\doxysection{\texorpdfstring{3.\+3 to 3.\+4}{3.\+3 to 3.\+4}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md499}
Base URLs of a client now follow the rules of \href{https://datatracker.ietf.org/doc/html/rfc3986\#section-5.2.2}{\texttt{ https\+://datatracker.\+ietf.\+org/doc/html/rfc3986\#section-\/5.\+2.\+2}} when merging URLs.\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md500}{}\doxysection{\texorpdfstring{3.\+2 to 3.\+3}{3.\+2 to 3.\+3}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md500}
\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md501}{}\doxysubsection{\texorpdfstring{Response\+::get\+Etag() quote stripping removed}{Response\+::get\+Etag() quote stripping removed}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md501}
{\ttfamily Guzzle\textbackslash{}Http\textbackslash{}Message\textbackslash{}Response\+::get\+Etag()} no longer strips quotes around the ETag response header\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md502}{}\doxysubsection{\texorpdfstring{Removed {\ttfamily Guzzle\textbackslash{}Http\textbackslash{}Utils}}{Removed {\ttfamily Guzzle\textbackslash{}Http\textbackslash{}Utils}}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md502}
The {\ttfamily Guzzle\textbackslash{}Http\textbackslash{}Utils} class was removed. This class was only used for testing.\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md503}{}\doxysubsection{\texorpdfstring{Stream wrapper and type}{Stream wrapper and type}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md503}
{\ttfamily Guzzle\textbackslash{}Stream\textbackslash{}Stream\+::get\+Wrapper()} and {\ttfamily Guzzle\textbackslash{}Stream\textbackslash{}Stream\+::get\+Stream\+Type()} are no longer converted to lowercase.\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md504}{}\doxysubsection{\texorpdfstring{curl.\+emit\+\_\+io became emit\+\_\+io}{curl.\+emit\+\_\+io became emit\+\_\+io}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md504}
Emitting IO events from a Request\+Mediator is now a parameter that must be set in a request\textquotesingle{}s curl options using the \textquotesingle{}emit\+\_\+io\textquotesingle{} key. This was previously set under a request\textquotesingle{}s parameters using \textquotesingle{}curl.\+emit\+\_\+io\textquotesingle{}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md505}{}\doxysection{\texorpdfstring{3.\+1 to 3.\+2}{3.\+1 to 3.\+2}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md505}
\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md506}{}\doxysubsection{\texorpdfstring{Curl\+Multi is no longer reused globally}{Curl\+Multi is no longer reused globally}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md506}
...
\end{DoxyCode}
\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md507}{}\doxysubsection{\texorpdfstring{No default path}{No default path}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md507}
...
\end{DoxyCode}
\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md508}{}\doxysubsection{\texorpdfstring{Less verbose Bad\+Response\+Exception}{Less verbose Bad\+Response\+Exception}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md508}
The exception message for {\ttfamily Guzzle\textbackslash{}Http\textbackslash{}Exception\textbackslash{}Bad\+Response\+Exception} no longer contains the full HTTP request and response information. You can, however, get access to the request and response object by calling {\ttfamily get\+Request()} or {\ttfamily get\+Response()} on the exception object.\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md509}{}\doxysubsection{\texorpdfstring{Query parameter aggregation}{Query parameter aggregation}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md509}
Multi-\/valued query parameters are no longer aggregated using a callback function. {\ttfamily Guzzle\textbackslash{}Http\textbackslash{}Query} now has a set\+Aggregator() method that accepts a {\ttfamily Guzzle\textbackslash{}Http\textbackslash{}Query\+Aggregator\textbackslash{}Query\+Aggregator\+Interface} object. This object is responsible for handling the aggregation of multi-\/valued query string variables into a flattened hash.\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md510}{}\doxysection{\texorpdfstring{2.\+8 to 3.\+x}{2.\+8 to 3.\+x}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md510}
\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md511}{}\doxysubsection{\texorpdfstring{Guzzle\textbackslash{}\+Service\textbackslash{}\+Inspector}{Guzzle\textbackslash{}\+Service\textbackslash{}\+Inspector}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md511}
...
\DoxyCodeLine{\{}
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{public}\ \textcolor{keyword}{static}\ \textcolor{keyword}{function}\ factory(\$config\ =\ array())}
\DoxyCodeLine{\ \ \ \ \{}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ \$config\ =\ Inspector::fromConfig(\$config,\ \$default,\ \$required);}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \$client\ =\ \textcolor{keyword}{new}\ \textcolor{keyword}{self}(}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \$config-\/>get(\textcolor{stringliteral}{'base\_url'}),}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \$config-\/>get(\textcolor{stringliteral}{'username'}),}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \$config-\/>get(\textcolor{stringliteral}{'api\_key'})}
\DoxyCodeLine{\ \ \ \ \ \ \ \ );}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \$client-\/>setConfig(\$config);}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ \$default\ =\ array();}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \$required\ =\ array(\textcolor{stringliteral}{'base\_url'},\ \textcolor{stringliteral}{'username'},\ \textcolor{stringliteral}{'api\_key'});}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \$config\ =\ Collection::fromConfig(\$config,\ \$default,\ \$required);}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \$client\ =\ \textcolor{keyword}{new}\ \textcolor{keyword}{self}(}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \$config-\/>get(\textcolor{stringliteral}{'base\_url'}),}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \$config-\/>get(\textcolor{stringliteral}{'username'}),}
...
\end{DoxyCode}
\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md512}{}\doxysubsection{\texorpdfstring{Convert XML Service Descriptions to JSON}{Convert XML Service Descriptions to JSON}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md512}
{\bfseries{Before}}
...
\end{DoxyCode}
\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md513}{}\doxysubsection{\texorpdfstring{Guzzle\textbackslash{}\+Service\textbackslash{}\+Description\textbackslash{}\+Service\+Description}{Guzzle\textbackslash{}\+Service\textbackslash{}\+Description\textbackslash{}\+Service\+Description}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md513}
...
\end{DoxyCode}
\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md514}{}\doxysubsection{\texorpdfstring{Guzzle\textbackslash{}\+Common\textbackslash{}\+Inflection\textbackslash{}\+Inflector}{Guzzle\textbackslash{}\+Common\textbackslash{}\+Inflection\textbackslash{}\+Inflector}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md514}
Namespace is now {\ttfamily Guzzle\textbackslash{}Inflection\textbackslash{}Inflector}\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md515}{}\doxysubsection{\texorpdfstring{Guzzle\textbackslash{}\+Http\textbackslash{}\+Plugin}{Guzzle\textbackslash{}\+Http\textbackslash{}\+Plugin}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md515}
Namespace is now {\ttfamily Guzzle\textbackslash{}Plugin}. Many other changes occur within this namespace and are detailed in their own sections below.\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md516}{}\doxysubsection{\texorpdfstring{Guzzle\textbackslash{}\+Http\textbackslash{}\+Plugin\textbackslash{}\+Log\+Plugin and Guzzle\textbackslash{}\+Common\textbackslash{}\+Log}{Guzzle\textbackslash{}\+Http\textbackslash{}\+Plugin\textbackslash{}\+Log\+Plugin and Guzzle\textbackslash{}\+Common\textbackslash{}\+Log}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md516}
...
\end{DoxyCode}
\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md517}{}\doxysubsection{\texorpdfstring{Guzzle\textbackslash{}\+Http\textbackslash{}\+Plugin\textbackslash{}\+Curl\+Auth\+Plugin}{Guzzle\textbackslash{}\+Http\textbackslash{}\+Plugin\textbackslash{}\+Curl\+Auth\+Plugin}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md517}
Now {\ttfamily Guzzle\textbackslash{}Plugin\textbackslash{}Curl\+Auth\textbackslash{}Curl\+Auth\+Plugin}.\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md518}{}\doxysubsection{\texorpdfstring{Guzzle\textbackslash{}\+Http\textbackslash{}\+Plugin\textbackslash{}\+Exponential\+Backoff\+Plugin}{Guzzle\textbackslash{}\+Http\textbackslash{}\+Plugin\textbackslash{}\+Exponential\+Backoff\+Plugin}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md518}
...
\end{DoxyCode}
\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md519}{}\doxysubsection{\texorpdfstring{Known Issues}{Known Issues}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md519}
\hypertarget{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md520}{}\doxysubsubsection{\texorpdfstring{\mbox{[}BUG\mbox{]} Accept-\/\+Encoding header behavior changed unintentionally.}{\mbox{[}BUG\mbox{]} Accept-\/\+Encoding header behavior changed unintentionally.}}\label{md_vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md520}
